...
try:
    ...
    ISC_COURSE_COMPLETION_S3_FOLDER = ENV_TOKENS.get('ISC_COURSE_COMPLETION_S3_FOLDER', '')
    ...
    CMC_COURSE_COMPLETION_S3_FOLDER = ENV_TOKENS.get('CMC_COURSE_COMPLETION_S3_FOLDER', '')
